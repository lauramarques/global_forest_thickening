...
# NFI Spain ----
data_nfi_spain <- readRDS(file.path(here::here(), "/data/inputs/data_nfi_spa.rds"))
data_nfi_spain
...
# NFI Sweeden ----
data_nfi_sweeden <- readRDS(file.path(here::here(), "/data/inputs/data_nfi_swe.rds"))
data_nfi_sweeden
...
# NFI Switzerland ----
data_nfi_switzerland <- readRDS(file.path(here::here(), "/data/inputs/data_nfi_swi.rds"))
data_nfi_switzerland
plot_stl(data_nfi_switzerland)
plot_map(data_nfi_switzerland)

# NFI Norway ----
data_nfi_norway <- readRDS(file.path(here::here(), "/data/inputs/data_nfi_nor.rds"))
data_nfi_norway
plot_stl(data_nfi_norway)
plot_map(data_nfi_norway)

# EFM Switzerland ----
data_efm_swi <- readRDS(file.path(here::here(), "/data/inputs/data_efm_swi.rds"))
data_efm_swi
plot_stl(data_efm_swi)
plot_map(data_efm_swi)

# Uholka plot ----
data_uholka <- readRDS(file.path(here::here(), "/data/inputs/data_uholka.rds"))
data_uholka
plot_stl(data_uholka)
plot_map(data_uholka)

# Greece sites ----
data_greece <- readRDS(file.path(here::here(), "/data/inputs/data_fp_gre.rds"))
data_greece
plot_stl(data_greece)
plot_map(data_greece)

# France sites ----
data_france <- readRDS(file.path(here::here(), "/data/inputs/data_fp_fra.rds"))
data_france
...
## bnp ----
data_bnp <- readRDS(file.path(here::here(), "/data/inputs/data_euf_bnp.rds"))
data_bnp
plot_stl(data_bnp)
plot_map(data_bnp)

## czu ----
data_czu <- readRDS(file.path(here::here(), "/data/inputs/data_euf_czu.rds"))
data_czu
plot_stl(data_czu)
plot_map(data_czu)

## forst ----
data_forst <- readRDS(file.path(here::here(), "/data/inputs/data_euf_forst.rds"))
data_forst
plot_stl(data_forst)
plot_map(data_forst)

## iberbas ----
data_iberbas <- readRDS(file.path(here::here(), "/data/inputs/data_euf_iberbas.rds"))
data_iberbas
plot_stl(data_iberbas)
plot_map(data_iberbas)

## incds ----
data_incds <- readRDS(file.path(here::here(), "/data/inputs/data_euf_incds.rds"))
data_incds
plot_stl(data_incds)
plot_map(data_incds)

## lwf ----
data_lwf <- readRDS(file.path(here::here(), "/data/inputs/data_euf_lwf.rds"))
data_lwf
plot_stl(data_lwf)
plot_map(data_lwf)

## nbw ----
data_nbw <- readRDS(file.path(here::here(), "/data/inputs/data_euf_nbw.rds"))
data_nbw
plot_stl(data_nbw)
plot_map(data_nbw)

## nfr ----
data_nfr_swi <- readRDS(file.path(here::here(), "/data/inputs/data_nfr_swi.rds"))
data_nfr_swi
plot_stl(data_nfr_swi)
plot_map(data_nfr_swi)

## nwfva ---- 
data_nwfva <- readRDS(file.path(here::here(), "/data/inputs/data_euf_nwfva.rds"))
data_nwfva 
plot_stl(data_nwfva)
plot_map(data_nwfva)

## tuzvo ----
data_tuzvo <- readRDS(file.path(here::here(), "/data/inputs/data_euf_tuzvo.rds"))
data_tuzvo
plot_stl(data_tuzvo)
plot_map(data_tuzvo)

## ul ----
data_ul <- readRDS(file.path(here::here(), "/data/inputs/data_euf_ul.rds"))
data_ul
plot_stl(data_ul)
plot_map(data_ul)

## unito ----
data_unito <- readRDS(file.path(here::here(), "/data/inputs/data_euf_unito.rds"))
data_unito
plot_stl(data_unito)
plot_map(data_unito)

## urk ----
data_urk <- readRDS(file.path(here::here(), "/data/inputs/data_euf_urk.rds"))
data_urk
plot_stl(data_urk)
plot_map(data_urk)

## wuls ----
data_wuls <- readRDS(file.path(here::here(), "/data/inputs/data_euf_wuls.rds"))
data_wuls
plot_stl(data_wuls)
plot_map(data_wuls)
...
## Luquillo ----
data_luquillo <- readRDS(file.path(here::here(), "/data/inputs/data_luquillo.rds"))
data_luquillo
...
## SCBI ----
data_scbi <- readRDS(file.path(here::here(), "/data/inputs/data_scbi.rds"))
data_scbi
plot_stl(data_scbi)
plot_map(data_scbi)

## Palanam ----
data_palanam <- readRDS(file.path(here::here(), "/data/inputs/data_palanam.rds"))
data_palanam
plot_stl(data_palanam)
plot_map(data_palanam)

## SERC ----
data_serc <- readRDS(file.path(here::here(), "/data/inputs/data_serc.rds"))
data_serc
plot_stl(data_serc)
plot_map(data_serc)

## Wytham woods ----
data_wytham <- readRDS(file.path(here::here(), "/data/inputs/data_wytham.rds"))
data_wytham
plot_stl(data_wytham)
plot_map(data_wytham)

## Pasoh woods ----
data_pasoh <- readRDS(file.path(here::here(), "/data/inputs/data_pasoh.rds"))
data_pasoh
plot_stl(data_pasoh)
plot_map(data_pasoh)
...
## Mudumalai ----
data_mudumalai <- readRDS(file.path(here::here(), "/data/inputs/data_mudumalai.rds"))
data_mudumalai
plot_stl(data_mudumalai)
plot_map(data_mudumalai)

# Forest plots ----
data_forestplots <- readRDS(file.path(here::here(), "/data/inputs/data_mz_forestplots.rds"))
data_forestplots
plot_stl(data_forestplots)
plot_map(data_forestplots)

# Australian plots ----
data_aus <- readRDS(file.path(here::here(), "/data/inputs/data_fp_aus.rds"))
data_aus
plot_stl(data_aus)
plot_map(data_aus)
...
saveRDS(data_all, file = file.path(here::here(), "/data/inputs/data_all.rds"))
...
plot_stl(data_unm)
plot_map(data_unm)
saveRDS(data_unm, file = file.path(here::here(), "/data/inputs/data_unm.rds"))
...
saveRDS(data_fil_biome1, file = file.path(here::here(), "/data/inputs/data_fil_biome1.rds"))
...
data_unm_biome4 <- data_unm |> filter(biomeID==4)
plot_stl(data_unm_biome4)
# filter data with upper quantile
data_fil_biome4 <- data_filter_fc(data_unm_biome4) 
plot_stl(data_fil_biome4)
saveRDS(data_fil_biome4, file = file.path(here::here(), "/data/inputs/data_fil_biome4.rds"))

## biome 5 ----
# Temperate Conifer Forests Forest
data_unm_biome5 <- data_unm |> filter(biomeID==5)
plot_stl(data_unm_biome5)
# filter data with upper quantile
data_fil_biome5 <- data_filter_fc(data_unm_biome5) 
plot_stl(data_fil_biome5)
saveRDS(data_fil_biome5, file = file.path(here::here(), "/data/inputs/data_fil_biome5.rds"))

## biome 6 ----
# Boreal Forests/Taiga Forest
data_unm_biome6 <- data_unm |> filter(biomeID==6)
plot_stl(data_unm_biome6)
# filter data with upper quantile
data_fil_biome6 <- data_filter_fc(data_unm_biome6) 
plot_stl(data_fil_biome6)
saveRDS(data_fil_biome6, file = file.path(here::here(), "/data/inputs/data_fil_biome6.rds"))

## biome 12 ----
# Mediterranean Forests
data_unm_biome12 <- data_unm |> filter(biomeID==12)
plot_stl(data_unm_biome12)
# filter data with upper quantile
data_fil_biome12 <- data_filter_fc(data_unm_biome12) 
plot_stl(data_fil_biome12)
saveRDS(data_fil_biome12, file = file.path(here::here(), "/data/inputs/data_fil_biome12.rds"))

# load data
data_fil_biome1 <- readRDS(file.path(here::here(), "/data/inputs/data_fil_biome1.rds"))
data_fil_biome2 <- readRDS(file.path(here::here(), "/data/inputs/data_fil_biome2.rds"))
...
saveRDS(data_fil_biomes, file = file.path(here::here(), "/data/inputs/data_fil_biomes.rds"))
